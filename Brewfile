...
brew "zplug"              # https://formulae.brew.sh/formula/zplug    # ターミナル用プラグイン管理
brew "peco"               # https://formulae.brew.sh/formula/peco     # インクリメンタルサーチ
brew "fzf"                # https://formulae.brew.sh/formula/fzf      # ファジー検索
