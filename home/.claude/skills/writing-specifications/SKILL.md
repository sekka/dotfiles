...
description: 機能仕様書と要件定義書の作成を支援します。ユーザーストーリー、受け入れ条件、仕様書テンプレートを提供します。要件定義、開発仕様書作成が必要な場合に使用してください。
---
...
機能仕様書、ユーザーストーリー、受け入れ条件の作成と優先順位付けを包括的に支援するスキルです。
...
- [TEMPLATES.md](./TEMPLATES.md) - 仕様書テンプレート集
- [EXAMPLES.md](./EXAMPLES.md) - ユーザーストーリー例
