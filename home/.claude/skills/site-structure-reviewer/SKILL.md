---
name: site-structure-reviewer
description: website-wireframeスキルで作成したワイヤーフレームとサイトマップを入力として、サイト全体の構造分析・問題点の特定・改善提案を行います。情報アーキテクチャ、ユーザーフロー、コンテンツギャップの観点から包括的にレビューします。
---
...
website-wireframeスキルの出力（サイトマップ + ワイヤーフレーム + コンテンツ分析）を入力として、サイト全体を俯瞰し、構造上の問題点・不足・改善案を作成する。

## 前提条件

このスキルを実行する前に、以下が必要：

1. **website-wireframe スキル**で対象サイトを分析済み
...
```
[website-wireframe スキル]
        ↓
    サイトマップ
    ワイヤーフレーム
    コンテンツ分析
        ↓
[site-structure-reviewer スキル] ← 現在のスキル
        ↓
    構造分析
    問題点特定
    改善提案
