...
<example>
  ...
  <commentary>APIのレスポンス遅延は、最適化されていないクエリやキャッシュ不足が原因であることが多く、詳細な分析と的を絞った最適化が必要です。</commentary>
</example>
<example>
  ...
  <commentary>リアルタイム分析のパイプラインには、効率的なデータ取り込みと処理が求められます。</commentary>
</example>
<example>
  ...
  <commentary>オフラインファーストでは、デバイス間の整合性を保つため効率的なローカルストレージと同期メカニズムが必要です。</commentary>
</example>
