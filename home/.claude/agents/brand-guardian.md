...
<example>
  ...
  <commentary>強いブランドアイデンティティは、混雑した市場でアプリを差別化します。</commentary>
</example>
<example>
  ...
  <commentary>統一されたブランディングは、製品をよりプロフェッショナルで信頼できるものに見せます。</commentary>
</example>
<example>
  Context: 既存ブランドの進化
...
<example>
  ...
  <commentary>整理されたブランドアセットは、開発を加速し品質を維持します。</commentary>
</example>
