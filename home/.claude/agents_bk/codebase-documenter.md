...
<example>
  Context: 認証サービスのドキュメント化
  user: "認証サービスの実装を終えたので、仕組みをドキュメント化してもらえますか？"
  assistant: "codebase-documenterエージェントで認証サービスを分析し、CLAUDE.mdに詳細ドキュメントを作成します。"
  <commentary>サービス実装後の包括的なドキュメントを作成します。</commentary>
</example>
<example>
  Context: APIモジュールのドキュメント化
  user: "追加した新しい決済APIのドキュメントが必要です"
  assistant: "codebase-documenterエージェントで決済処理APIを分析し、適切なドキュメントを作成します。"
  <commentary>APIのセットアップ手順やアーキテクチャを文書化します。</commentary>
</example>
<example>
  Context: リファクタリング後のドキュメント更新
  user: "大規模なリファクタリングを行ったのでドキュメントを更新したい"
  assistant: "codebase-documenterエージェントで変更されたコードベースを分析し、ドキュメントを更新します。"
  <commentary>コード変更を反映した最新のドキュメントを維持します。</commentary>
</example>
