...
### 0-A. `home/.claude/skills/user-pmo-wbs/SKILL.md` ✅ DONE
...
### 0-B. `home/.claude/skills/user-pm-report/SKILL.md` ✅ DONE

**Report Format の Risk Status 直後**（line 107 後）にセクション追加:
...
**変更1** ✅ DONE — Q5b (line 79) 追加済み

**変更2** ✅ DONE — discovery.md Approver ヘッダー（line 114）追加済み

**変更3** ✅ DONE — pmo.yaml テンプレート（client フィールドの直後）:
